...
struct myproject : public sc_module {
    ...
    sc_out< sc_lv<7> > w2_V_address0;
    sc_out< sc_logic > w2_V_ce0;
    sc_out< sc_lv<128> > w2_V_d0;
    sc_in< sc_lv<128> > w2_V_q0;
    sc_out< sc_logic > w2_V_we0;
    sc_out< sc_lv<7> > w2_V_address1;
    sc_out< sc_logic > w2_V_ce1;
    sc_out< sc_lv<128> > w2_V_d1;
    sc_in< sc_lv<128> > w2_V_q1;
    ...
    sc_signal< sc_lv<7> > conv_2d_cl_me_ap_fixed_ap_fixed_16_14_5_3_0_config2_U0_weights_V_address0;
