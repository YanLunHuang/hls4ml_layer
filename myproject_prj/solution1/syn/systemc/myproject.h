...
struct myproject : public sc_module {
    ...
    sc_signal< sc_lv<16> > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID;
