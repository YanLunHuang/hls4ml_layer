...
myproject::myproject(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0->res_V_V_TDATA(zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA);
    zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0->res_V_V_TVALID(zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID);
    zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0->res_V_V_TREADY(layer2_out_V_V_TREADY);
    ...
    sensitive << ( zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_done );
    ...
    sensitive << ( zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA );

    SC_METHOD(thread_layer2_out_V_V_TVALID);
    sensitive << ( zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID );
    ...
    sc_trace(mVcdFile, zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA, "zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA");
    sc_trace(mVcdFile, zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID, "zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID");
...
void myproject::thread_ap_idle() {
    ap_idle = (Block_proc_U0_ap_idle.read() & zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_idle.read());
}
...
void myproject::thread_ap_sync_done() {
    ap_sync_done = (Block_proc_U0_ap_done.read() & zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_done.read());
}
...
void myproject::thread_layer2_out_V_V_TDATA() {
    layer2_out_V_V_TDATA = zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA.read();
}

void myproject::thread_layer2_out_V_V_TVALID() {
    layer2_out_V_V_TVALID = zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID.read();
}

void myproject::thread_zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_continue() {
    zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_continue = ap_sync_done.read();
}
