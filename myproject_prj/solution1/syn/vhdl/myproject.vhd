...
architecture behav of myproject is 
    ...
    "myproject,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=1.199250,HLS_SYN_LAT=6437,HLS_SYN_TPT=6438,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=116,HLS_SYN_LUT=544,HLS_VERSION=2019_2}";
    ...
    signal zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA : STD_LOGIC_VECTOR (15 downto 0);
    signal zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID : STD_LOGIC;
...
begin
    ...
    ap_idle <= (zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_idle and Block_proc_U0_ap_idle);
    ...
    ap_sync_done <= (zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_done and Block_proc_U0_ap_done);
    ...
    layer2_out_V_V_TDATA <= zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TDATA;
    layer2_out_V_V_TVALID <= zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_res_V_V_TVALID;
    zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_ap_continue <= ap_sync_done;
