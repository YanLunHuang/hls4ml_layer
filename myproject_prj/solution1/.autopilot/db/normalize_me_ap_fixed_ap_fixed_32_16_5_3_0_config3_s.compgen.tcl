...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_V_V_TDATA { I 32 vector } data_V_V_TVALID { I 1 bit } data_V_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_V_V_TDATA { O 32 vector } res_V_V_TVALID { O 1 bit } res_V_V_TREADY { I 1 bit } } \
} "
} else {
