...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_0_V_V_TDATA { O 16 vector } res_0_V_V_TVALID { O 1 bit } res_0_V_V_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_1_V_V_TDATA { O 16 vector } res_1_V_V_TVALID { O 1 bit } res_1_V_V_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_2_V_V_TDATA { O 16 vector } res_2_V_V_TVALID { O 1 bit } res_2_V_V_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_3_V_V_TDATA { O 16 vector } res_3_V_V_TVALID { O 1 bit } res_3_V_V_TREADY { I 1 bit } } \
} "
} else {
