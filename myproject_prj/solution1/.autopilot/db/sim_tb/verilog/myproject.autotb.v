...
`define AESL_MEM_w2_V AESL_automem_w2_V
`define AESL_MEM_INST_w2_V mem_inst_w2_V
...
`define AUTOTB_TVIN_w2_V  "./c.myproject.autotvin_w2_V.dat"
...
`define AUTOTB_TVIN_w2_V_out_wrapc  "./rtl.myproject.autotvin_w2_V.dat"
...
parameter LATENCY_ESTIMATION = 71164;
...
wire [11 : 0] w2_V_address0;
wire  w2_V_ce0;
wire [4095 : 0] w2_V_d0;
wire [4095 : 0] w2_V_q0;
wire  w2_V_we0;
wire [11 : 0] w2_V_address1;
wire  w2_V_ce1;
wire [4095 : 0] w2_V_d1;
wire [4095 : 0] w2_V_q1;
wire  w2_V_we1;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .w2_V_address0(w2_V_address0),
    .w2_V_ce0(w2_V_ce0),
    .w2_V_d0(w2_V_d0),
    .w2_V_q0(w2_V_q0),
    .w2_V_we0(w2_V_we0),
    .w2_V_address1(w2_V_address1),
    .w2_V_ce1(w2_V_ce1),
    .w2_V_d1(w2_V_d1),
    .w2_V_q1(w2_V_q1),
    .w2_V_we1(w2_V_we1),
...
//------------------------arrayw2_V Instantiation--------------

// The input and output of arrayw2_V
wire    arrayw2_V_ce0, arrayw2_V_ce1;
wire    arrayw2_V_we0, arrayw2_V_we1;
wire    [11 : 0]    arrayw2_V_address0, arrayw2_V_address1;
wire    [4095 : 0]    arrayw2_V_din0, arrayw2_V_din1;
wire    [4095 : 0]    arrayw2_V_dout0, arrayw2_V_dout1;
wire    arrayw2_V_ready;
wire    arrayw2_V_done;

`AESL_MEM_w2_V `AESL_MEM_INST_w2_V(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayw2_V_ce0),
    .we0        (arrayw2_V_we0),
    .address0   (arrayw2_V_address0),
    .din0       (arrayw2_V_din0),
    .dout0      (arrayw2_V_dout0),
    .ce1        (arrayw2_V_ce1),
    .we1        (arrayw2_V_we1),
    .address1   (arrayw2_V_address1),
    .din1       (arrayw2_V_din1),
    .dout1      (arrayw2_V_dout1),
    .ready      (arrayw2_V_ready),
    .done    (arrayw2_V_done)
);

// Assignment between dut and arrayw2_V
assign arrayw2_V_address0 = w2_V_address0;
assign arrayw2_V_ce0 = w2_V_ce0;
assign w2_V_q0 = arrayw2_V_dout0;
assign arrayw2_V_we0 = 0;
assign arrayw2_V_din0 = 0;
assign arrayw2_V_we1 = 0;
assign arrayw2_V_din1 = 0;
assign arrayw2_V_ready=    ready;
assign arrayw2_V_done = 0;
