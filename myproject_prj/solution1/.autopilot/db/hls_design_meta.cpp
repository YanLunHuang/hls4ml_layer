...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("w2_V_address0", 7, hls_out, 4, "ap_memory", "mem_address", 1),
	Port_Property("w2_V_ce0", 1, hls_out, 4, "ap_memory", "mem_ce", 1),
	Port_Property("w2_V_d0", 128, hls_out, 4, "ap_memory", "mem_din", 1),
	Port_Property("w2_V_q0", 128, hls_in, 4, "ap_memory", "mem_dout", 1),
	Port_Property("w2_V_we0", 1, hls_out, 4, "ap_memory", "mem_we", 1),
	Port_Property("w2_V_address1", 7, hls_out, 4, "ap_memory", "mem_address", 1),
	Port_Property("w2_V_ce1", 1, hls_out, 4, "ap_memory", "mem_ce", 1),
	Port_Property("w2_V_d1", 128, hls_out, 4, "ap_memory", "mem_din", 1),
	Port_Property("w2_V_q1", 128, hls_in, 4, "ap_memory", "mem_dout", 1),
