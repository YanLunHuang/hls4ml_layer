...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"OutputProcess" : [
			...
			{"ID" : "2", "Name" : "zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0"}],
		"Port" : [
			...
			{"Name" : "layer2_out_V_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0", "Port" : "res_V_V"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "const_size_in_1", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "const_size_out_1", "Type" : "Vld", "Direction" : "O"}]},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0", "Parent" : "0", "Child" : ["3", "4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0.regslice_both_res_V_V_U", "Parent" : "2"}]}


set ArgLastReadFirstWriteLatency {
	myproject {
		input_1_V_V {Type I LastRead 514 FirstWrite -1}
		layer2_out_V_V {Type O LastRead -1 FirstWrite 1}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "6429", "Max" : "6429"}
]}
...
set ArgLastReadFirstWriteLatency {
	myproject {
		input_1_V_V {Type I LastRead 6 FirstWrite -1}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "6438", "Max" : "6438"}
]}
