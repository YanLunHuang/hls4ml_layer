...
ap_fixed<16, 14, (ap_q_mode) 5, (ap_o_mode)3, 0> w2[576]);
...
ap_fixed<16, 14, (ap_q_mode) 5, (ap_o_mode)3, 0> w2[576])
{
	...
	else
	{
		...
		sc_bv<128>* w2_V_tvin_wrapc_buffer = new sc_bv<128>[72];
		...
		tcl_file.set_num(72, &tcl_file.w2_V_depth);
