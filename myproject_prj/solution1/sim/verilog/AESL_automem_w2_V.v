...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.myproject.autotvin_w2_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.myproject.autotvout_w2_V.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 4096;
parameter ADDR_WIDTH = 32'd 12;
parameter DEPTH = 32'd 2304;
parameter DLY = 0.1;
