...
set w2_group [add_wave_group w2(memory) -into $cinputgroup]
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_we1 -into $w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_q1 -into $w2_group -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_d1 -into $w2_group -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_ce1 -into $w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_address1 -into $w2_group -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_we0 -into $w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_q0 -into $w2_group -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_d0 -into $w2_group -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_ce0 -into $w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/AESL_inst_myproject/w2_V_address0 -into $w2_group -radix hex
...
add_wave /apatb_myproject_top/LENGTH_w2_V -into $tb_portdepth_group -radix hex
...
set tb_w2_group [add_wave_group w2(memory) -into $tbcinputgroup]
add_wave /apatb_myproject_top/w2_V_we1 -into $tb_w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/w2_V_q1 -into $tb_w2_group -radix hex
add_wave /apatb_myproject_top/w2_V_d1 -into $tb_w2_group -radix hex
add_wave /apatb_myproject_top/w2_V_ce1 -into $tb_w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/w2_V_address1 -into $tb_w2_group -radix hex
add_wave /apatb_myproject_top/w2_V_we0 -into $tb_w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/w2_V_q0 -into $tb_w2_group -radix hex
add_wave /apatb_myproject_top/w2_V_d0 -into $tb_w2_group -radix hex
add_wave /apatb_myproject_top/w2_V_ce0 -into $tb_w2_group -color #ffff00 -radix hex
add_wave /apatb_myproject_top/w2_V_address0 -into $tb_w2_group -radix hex
